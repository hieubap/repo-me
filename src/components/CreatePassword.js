              ...
              >
                <div className="box box--margin-bottom-4 box--flex-direction-row">
                  <ul className="progressbar">
                    <li className="active">Tạo mật khẩu</li>
                    <li className>Ví an toàn</li>
                    <li className>Xác nhận cụm mật khẩu khôi phục bí mật</li>
                  </ul>
                </div>
                ...
                <h4 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography typography--h4 typography--weight-normal typography--style-normal typography--align-center typography--color-text-default">
                  Mật khẩu này sẽ chỉ mở khóa ví của bạn trên thiết bị này.
                </h4>
                <div className="box box--margin-top-3 box--flex-direction-row box--justify-content-center box--display-flex">
                  <form className="create-password__form">
                    <div className="form-field">
                      <label className="box box--flex-direction-row">
                        <div className="form-field__heading">
                          <div className="box form-field__heading-title box--display-flex box--flex-direction-row box--align-items-baseline">
                            <h6 className="box box--margin-top-1 box--margin-bottom-1 box--display-inline-block box--flex-direction-row typography typography--h6 typography--weight-bold typography--style-normal typography--color-text-default">
                              Mật khẩu mới (tối thiểu 8 ký tự)
                            </h6>
                          </div>
                          <div className="box form-field__heading-detail box--margin-right-2 box--flex-direction-row box--text-align-end">
                    ...
                    {/* <div className="box box--margin-bottom-4 box--flex-direction-row box--justify-content-space-between box--align-items-center box--display-flex">
                      <label className="create-password__form__terms-label">
                        ...
                        <h5 className="box box--margin-top-1 box--margin-bottom-1 box--margin-left-3 box--flex-direction-row typography typography--h5 typography--weight-normal typography--style-normal typography--color-text-default">
                          <span>
                            {" "}
                            Tôi hiểu rằng MetaMask không thể khôi phục mật khẩu
                            này cho tôi.{" "}
                            <a
                    ...
                    <button
                      className="button btn--rounded btn-primary btn--large create-password__form--submit-button"
