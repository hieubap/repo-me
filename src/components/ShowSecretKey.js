              ...
              <div className="recovery-phrase" data-testid="recovery-phrase">
                <div className="box box--flex-direction-row">
                  <ul className="progressbar">
                    ...
                    <li className="active">Ví an toàn</li>
                ...
                <div className="box box--margin-bottom-4 box--flex-direction-row box--justify-content-center box--text-align-center box--display-flex">
                  <h2 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography recovery-phrase__header typography--h2 typography--weight-bold typography--style-normal typography--color-text-default">
                    Viết ra Cụm Mật Khẩu Khôi Phục Bí Mật của bạn
                  </h2>
                </div>
                <div className="box box--margin-bottom-4 box--flex-direction-row box--justify-content-center box--text-align-center box--display-flex">
                  <h4 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography typography--h4 typography--weight-normal typography--style-normal typography--color-text-default">
                    Viết ra Cụm Mật Khẩu Khôi Phục Bí Mật gồm 12 từ này, sau đó
                    lưu ở một nơi mà bạn tin tưởng và chỉ có bạn mới được phép
                    truy cập.
                  </h4>
                </div>
                {/* <div className="box recovery-phrase__tips box--margin-bottom-4 box--flex-direction-row box--text-align-left">
                  ...
                  <ul>
                    <li>
                      <h4 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography typography--h4 typography--weight-normal typography--style-normal typography--color-text-default">
                        Lưu trong một trình quản lý mật khẩu
                      </h4>
                    </li>
                    <li>
                      <h4 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography typography--h4 typography--weight-normal typography--style-normal typography--color-text-default">
                        Lưu giữ trong hộp ký gửi an toàn.
                      </h4>
                    </li>
                    <li>
                      <h4 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography typography--h4 typography--weight-normal typography--style-normal typography--color-text-default">
                        Viết ra và cất ở nhiều nơi bí mật.
                      </h4>
                    </li>
                  </ul>
                </div> */}
                <div className="box recovery-phrase__secret box--margin-bottom-4 box--padding-4 box--display-grid box--flex-direction-row box--rounded-md box--border-style-solid box--border-color-border-muted box--border-width-1">
                  <div
                    ...
                    className="recovery-phrase__chips recovery-phrase__chips--hidden"
                  >
                  ...
                  {/* <div className="recovery-phrase__secret-blocker">
                    ...
                    <h6 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography recovery-phrase__secret-blocker--text typography--h6 typography--weight-normal typography--style-normal typography--color-overlay-inverse">
                      Đảm bảo không có ai đang nhìn màn hình của bạn
                    </h6>
                  </div> */}
                </div>
                <div className="recovery-phrase__footer">
                  <button
                    className="button btn--rounded btn-primary recovery-phrase__footer--button"
                    data-testid="recovery-phrase-reveal"
                    role="button"
                    tabIndex={0}
                    onClick={() => {
                      document.getElementById("secret-key-12").className =
                        "recovery-phrase__chips";
                    }}
                  >
                    Hiện Cụm mật khẩu khôi phục bí mật
                  </button>
                </div>
              </div>
            </div>
