        ...
        <div className="main-container-wrapper">
          <div className="onboarding-flow">
            <div className="onboarding-flow__wrapper">
              ...
              >
                <div className="box box--flex-direction-row box--text-align-center">
                  <img src={require("./images/tada.png")} />
                  <h2 className="box box--margin-6 box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography typography--h2 typography--weight-bold typography--style-normal typography--color-text-default">
                    Tạo ví thành công
                  </h2>
                  <h4 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography typography--h4 typography--weight-normal typography--style-normal typography--color-text-default">
                    Bạn đã bảo vệ thành công ví của mình. Hãy đảm bảo an toàn và
                    bí mật cho Cụm Mật Khẩu Khôi Phục Bí Mật của bạn -- đây là
                    trách nhiệm của bạn!
                  </h4>
                </div>
                ...
                <ul>
                  <li>
                    <h4 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography typography--h4 typography--weight-normal typography--style-normal typography--color-text-default">
                      MetaMask không thể khôi phục Cụm Mật Khẩu Khôi Phục Bí Mật
                      của bạn.
                    </h4>
                  </li>
                  <li>
                    <h4 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography typography--h4 typography--weight-normal typography--style-normal typography--color-text-default">
                      MetaMask sẽ không bao giờ hỏi về Cụm Mật Khẩu Khôi Phục Bí
                      Mật của bạn.
                    </h4>
                  </li>
                  <li>
                    <h4 className="box box--margin-top-1 box--margin-bottom-1 box--flex-direction-row typography typography--h4 typography--weight-normal typography--style-normal typography--color-text-default">
                      <span>
                        ...
                        với bất kỳ ai, nếu không bạn sẽ có nguy cơ bị mất tiền{" "}
                      </span>
                    </h4>
                  </li>
                  <li>
                ...
                <div className="box creation-successful__actions box--margin-top-6 box--flex-direction-row">
                  <a className="button btn-link" role="button" tabIndex={0}>
                    Cấu hình nâng cao
                  </a>
                  <button
