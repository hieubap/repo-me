      ...
      <div className="app os-mac">
        <div className="onboarding-app-header">
          <div className="onboarding-app-header__contents">
            ...
            >
              <img src={require("./images/coin-wallet.png")} style={{ width: 80 }} />
              {/* <svg
                height={30}
            ...
            <div className="onboarding-flow__wrapper">
              ...
              >
                      ...
                      >
                        <li className="slide selected">
                          <div>
                            ...
                            <p className="box box--margin-top-1 box--margin-right-6 box--margin-bottom-1 box--margin-left-6 box--flex-direction-row typography typography--p typography--weight-normal typography--style-normal typography--align-center typography--color-text-default">
                              Cho phép mọi người có thể truy cập vào thế giới
                              web3.
                            </p>
                            <div className="onboarding-welcome__mascot">
                              <div style={{ zIndex: 0 }}>
                                <img
                                  src={require("./images/coin-wallet.png")}
                                  style={{ width: 200 }}
                                />
                              </div>
                            </div>
                ...
                <ul className="onboarding-welcome__buttons">
                  ...
                  <li>
                    <button
                      className="button btn--rounded btn-secondary"
